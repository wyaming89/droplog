          ...
          {chartData.length > 0 ? (
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
                ...
                <YAxis stroke="#666" fontSize={12} domain={['dataMin - 1', 'dataMax + 1']} tickLine={false} axisLine={false} hide />
                <Tooltip
                  contentStyle={{
                ...
                >
                  <LabelList 
                    ...
                    fill={color} 
                    fontSize={11} 
                    formatter={(val: number) => val.toFixed(currentMetricConfig?.decimal_places || 0)}
                  />
                </Area>
              </AreaChart>
            </ResponsiveContainer>
